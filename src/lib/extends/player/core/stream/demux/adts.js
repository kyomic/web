...
export function getAudioConfig (observer, data, offset, audioCodec) {
  ...
  if (adtsSampleingIndex > adtsSampleingRates.length - 1) {
    observer.trigger( HLSEvent.ERROR, { type: ErrorTypes.MEDIA_ERROR, details: ErrorDetails.FRAG_PARSING_ERROR, fatal: true, reason: `invalid ADTS sampling index:${adtsSampleingIndex}` });
    return;
  }
